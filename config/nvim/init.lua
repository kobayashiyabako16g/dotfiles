...
local denops_src = vim.fn.expand("~/.nix-profile/plugin/denops.vim")
local denops_hello = vim.fn.expand("~/.cache/dpp/repos/github/vim-denops/denops-helloworld.vim")
...
vim.opt.runtimepath:append(denops_hello)
